      ...
      {data && (
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              { label: "Usuarios", value: data.stats.totalUsers, color: "bg-uniko-blue" },
              ...
              { label: "Ingresos", value: `RD$${(data.stats.totalRevenue / 100).toLocaleString()}`, color: "bg-uniko-red" },
            ].map((stat, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              {data.stats.pendingVendors === 0 ? <p className="text-uniko-blue/70 text-center py-4">No hay pendientes</p> : <p className="text-center py-4">{data.stats.pendingVendors} pendientes de revisión</p>}
              <div className="mt-4">
